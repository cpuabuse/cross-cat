...
function testShowNonPrinting() {
	describe("non-printing", function() {
		...
		describe("line feed character", function() {
			it("should have expected value", function() {
				assert.strictEqual(
					showNonPrinting.showNonPrinting(inputData.lineFeedCharacter),
					expected.lineFeedCharacter
				);
			});
		});
		...
		describe("carriage return character", function() {
			it("should have expected value", function() {
				assert.strictEqual(
					showNonPrinting.showNonPrinting(inputData.carriageReturnCharacter),
					expected.carriageReturnCharacter
				);
			});
		});
		...
		describe("space chatacter", function() {
			it("should have expected value", function() {
				assert.strictEqual(
					showNonPrinting.showNonPrinting(inputData.space),
					expected.space
				);
			});
		});
		...
		describe("numbers", function() {
			...
			it("should have expected value", function() {
				assert.strictEqual(
					showNonPrinting.showNonPrinting(inputData.numbers),
					expected.numbers
				);
			});
		});
		...
		describe("letters", function() {
			...
			it("should have expected value", function() {
				assert.strictEqual(
					showNonPrinting.showNonPrinting(inputData.letters),
					expected.letters
				);
			});
		});
		...
		describe("DEL character", function() {
			it("should have expected value", function() {
				assert.strictEqual(
					showNonPrinting.showNonPrinting(inputData.del),
					expected.del
				);
			});
		});
		...
		describe("extendedCharacters", function() {
			it("should have expected amount of characters", function() {
				assert.strictEqual(
					showNonPrinting.showNonPrinting(inputData.getExtendedLower()),
					expected.extendedCharacters
				);
			});
		});
		...
		describe("othersExtendedCharacters", function() {
			it("should have expected amount of characters", function() {
				assert.strictEqual(
					showNonPrinting.showNonPrinting(inputData.extendedHigher),
					expected.extendedHigher
				);
			});
		});
		...
		describe("unicode characters", function() {
			it("should have expected values", function() {
				assert.strictEqual(
					showNonPrinting.showNonPrinting(inputData.unicodeCharacter),
					expected.unicodeCharacter
				);
			});
		});
	});
